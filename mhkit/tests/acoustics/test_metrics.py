...
class TestMetrics(unittest.TestCase):
    ...
    def test_spl(self):
        ...
        cd_spl10_tail = np.array(
            [
                [82.50736, 80.50317, 80.87118, 83.18715, 81.44459],
                [83.363754, 81.933586, 81.51899, 83.47768, 81.85001],
                [83.13375, 81.261314, 81.41166, 83.528534, 81.81753],
                [83.350945, 81.70521, 81.42419, 83.45481, 81.4712],
                [83.096565, 80.90549, 81.397545, 83.36795, 81.5738],
            ]
        )
        ...
        cd_spl3_freq_tail = np.array(
            [16254.986772, 20480.0, 25803.183102, 32509.973544, 40960]
        )
        cd_spl3_tail = np.array(
            [
                [82.22458, 80.37833, 81.21788, 83.5725, 80.37073],
                [83.11681, 81.848434, 81.772064, 83.928505, 80.70311],
                [82.95174, 81.13474, 81.67803, 83.96902, 80.6636],
                [83.1788, 81.532005, 81.694954, 83.796875, 80.38368],
                [82.86294, 80.70353, 81.6905, 83.76083, 80.53248],
            ]
        )
