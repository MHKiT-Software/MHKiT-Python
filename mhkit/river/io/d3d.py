...
Functions:
----------
- get_all_time: Get all time stamps from a D3D simulation
- index_to_seconds: Convert time index to simulation seconds
- seconds_to_index: Convert simulation seconds to time index
- get_layer_data: Extract data for specific layers and time steps
- create_points: Generate point datasets for interpolation
- variable_interpolation: Interpolate variables onto specified points
- get_all_data_points: Extract data for all layers at a time step
- turbulent_intensity: Calculate turbulent intensity from model outputs
- list_variables: List all variables in a DataArray or Dataset
