...
timeall, Hs, Tp, Dp = mhkit.wave.io.cdip.request_data(stn,startdate,enddate)
...
pHs.plot(timeall,Hs,'b')
pTp.plot(timeall,Tp,'b')
pDp.scatter(timeall,Dp,color='blue',s=5) # Plot Dp variable as a scatterplot, rather than line
